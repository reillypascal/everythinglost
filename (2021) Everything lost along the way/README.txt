This piece uses the open-source Yamaha DX7 emulator "Dexed." Dexed 0.9.6 (current version as of 10-28-2021) is included in the subfolder "Dexed" in the patch folder, or the latest version can be downloaded at https://asb2m10.github.io/dexed/. The preset file "ROM1A.syx" is located in the folder "DX7 ROM1" within the "Dexed" folder.
